...
Pod::Spec.new do |s|
  s.name             = 'TestSpecs'
  s.version          = '0.1.0'
  s.summary          = 'A short description of TestSpecs.'
...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/sdk@solar-engine.com/TestSpecs.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'TestSpecs' => ['TestSpecs/Assets/*.png']
  # }
